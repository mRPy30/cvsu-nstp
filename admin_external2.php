...
<div class="admin">
    <div class="inner_admin">
        <button type="submit" class="btn btn-primary">Civil Welfare Training Service</button>
    </div>

    <div class="inner_admin-2">
        <button type="submit" class="btn btn-primary">Reserve Officers Training Coprs</button>
    </div>
</div>
